...
class TreinoService implements TreinoServiceInterface {
    ...
    public function update(Request $request, string $id) {
        ...
        $treinoCadastrado = $this->repository->find($id);

        DB::beginTransaction();
        try{
            $registro = $treinoCadastrado->update($request);
            DB::comit();
            return $registro;
        }catch(Exception $e){
            DB::rollback();
    ...
    public function destroy(string $id) {
        $treinoCadastrado = $this->show($id);

        DB::beginTransaction();
        try{
            $registro = $treinoCadastrado->delete;
            DB::comit();
            return $registro;
        }catch(Exception $e){
            DB::rollback();
