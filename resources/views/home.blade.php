                ...
                <div class="row">
                  <div class="col-lg-6 col-md-7 offset-md-6 offset-md-5">
                    <div class="detail-box">
                      ...
                      <p>
                        CONSTRUA O CORPO QUE VOCE SEMPRE SONHOU COM A FITAPP
                      </p>
                      <div class="btn-box">
                        <a href="" class="btn-1">
                          Read More
      ...
      <div class="us_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Sinta-se confortável com o acompanhamento de qualidade que oferecemos ao longo do processo
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            <h5>
              PLANEJAMENTO DE SAÚDE ADEQUADO
            </h5>
            <p>
                Toda a sua saúde é planejada de acordo com suas necessidades
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Personalizamos nossos serviços de acordo com suas necessidades
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Compartilhe com seus amigos e familiares os resultados obtidos!
            </p>
          </div>
        </div>
      </div>
